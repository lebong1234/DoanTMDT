...
namespace Webbanson.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(ComesticsContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CategoryId,CategoryName,Description,ImageUrl")] Category category)
        {
